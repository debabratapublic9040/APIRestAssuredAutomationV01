...
public class UserTests2 {
	...
	public void test_getUserByUserName()
	{
		...
		Response response=UsersEndPoints2.readUser(this.userPayload.getUsername());
		Assert.assertEquals(response.getStatusCode(),200);
	...
	public void test_updateUserByName()
	{
		...
		Response response=UsersEndPoints2.updateUser(this.userPayload.getUsername(), userPayload);
		Assert.assertEquals(response.getStatusCode(),200);
		logger.info("***************Modified User Data***************");
		
		//Checking the data post update
		logger.info("***************Modify the User Data***************");
		Response responseAfterUpdate=UsersEndPoints2.readUser(this.userPayload.getUsername());
	...
	public void test_deleteUserByUserName()
	{
		...
		Response response=UsersEndPoints2.deleteUser(this.userPayload.getUsername());
		Assert.assertEquals(response.getStatusCode(),200);
